...
- **Feature Planning & SDD Pipeline:** Read `Vault/OS/Planning_Directives.md`
...
- When the user asks to **"Build a new feature"** or **"Draft a plan"**: Load `Vault/OS/Planning_Directives.md` and execute the 4-step SDD Pipeline.
...
- **功能規劃與 SDD 流程:** 讀取 `Vault/OS/Planning_Directives.md`
...
- 當用戶要求 **"建立新功能" (Build a new feature)** 或 **"草擬計劃" (Draft a plan)** 時：載入 `Vault/OS/Planning_Directives.md` 並執行四步 SDD 流程。
