...
- Canonical guide sources live in `docs/User_Guide.en.md` and `docs/User_Guide.zh-Hant.md`.
...
Each task is one local Markdown file with:
...
Official Obsidian documentation lists table view support from Obsidian 1.9. The v2.1 feasibility pass tested Obsidian Desktop 1.12.7.
...
- Automated tests validate Base structure statically; final visual behaviour remains K-controlled UAT.
