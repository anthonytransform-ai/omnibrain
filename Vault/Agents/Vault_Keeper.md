...
2. When the human approves archiving, format the note with frontmatter and save it to `Vault/Plans/`.
3. When the human approves knowledge distillation, update only the specific System or Feature notes that need the new durable truth.
