...
Before any planning or implementation can begin, you MUST actively read the project's rules files (`Project_Config.md`, `Anti_Patterns.md`) and relevant architecture docs. This "Context Engineering" step prevents context starvation and ensures you are aware of existing technical constraints before drafting a plan.
